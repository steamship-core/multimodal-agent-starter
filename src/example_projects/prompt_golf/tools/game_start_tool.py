...
class GameStartTool(Tool):
    ...
    name: str = "GameStartTool"
    human_description: str = f"Starts a new game of {game_name}."
    agent_description = (
        f"Used to start a new game of {game_name}. "
        "Use this tool whenever a user asks to start a new game of {game_name}. "
        "Input: The request to start a new game. "
        "Output: An announcement of the new game starting."
    )
